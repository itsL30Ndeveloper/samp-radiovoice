...
public SV_VOID:OnPlayerActivationKeyPress(SV_UINT:playerid, SV_UINT:keyid) 
{
    ...
    if(keyid == 0x42 && FreqNumber[playerid] >= 1)
    {
        ...
        SetPlayerSpecialAction(playerid,SPECIAL_ACTION_USECELLPHONE); // Animations : Use Radio Animation
...
public SV_VOID:OnPlayerActivationKeyRelease(SV_UINT:playerid, SV_UINT:keyid)
{
    ...
    if(keyid == 0x42 && FreqNumber[playerid] >= 1)
    {
        ...
        SetPlayerSpecialAction(playerid,SPECIAL_ACTION_STOPUSECELLPHONE); // Animations : Stop The Radio Animation
        SetPlayerAttachedObject(playerid,0,19942,6); // Radio Object
    }
    if(keyid == 0x42 && FreqNumber[playerid] == 0) return;
}
